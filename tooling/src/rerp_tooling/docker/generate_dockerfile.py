...
def generate_dockerfile(
    ...
    """Generate Dockerfile for a service. Returns the output path. Raises SystemExit(1) if template missing."""
...
def run(system: str, module: str, port: int = 8000, project_root: Optional[Path] = None) -> int:
    """CLI entry: generate Dockerfile. Returns 0 on success, 1 if template missing."""
