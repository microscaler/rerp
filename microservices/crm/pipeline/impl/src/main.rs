// This file uses generated code from the rerp_crm_pipeline_gen crate
...
use clap::Parser;
use rerp_crm_pipeline_gen::handlers::*;
use rerp_crm_pipeline_gen::registry::*;
use rerp_crm_pipeline_gen::*;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 pipeline example server listening on {addr}");
