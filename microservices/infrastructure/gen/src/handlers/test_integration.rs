...
impl TryFrom<HandlerRequest> for Request {
    ...
    fn try_from(req: HandlerRequest) -> Result<Self, Self::Error> {
        ...
        if let Some(v) = req.get_path_param("integrationId") {
            ...
            return Err(anyhow::anyhow!("Missing required parameter 'integrationId'"));
...
pub fn handler(req: TypedHandlerRequest<Request>) -> Response {
    crate::controllers::test_integration::handle(req)
}
