...
use crate::handlers::types::TemplateSelector;
...
pub struct Request {
    ...
    #[serde(rename = "template_selector")]
...
pub fn handler(req: TypedHandlerRequest<Request>) -> Response {
    crate::controllers::create_document_rendition::handle(req)
}
