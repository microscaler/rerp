// Implementation stub for handler 'get_document_template_version'
...
use rerp_documents_render_gen::handlers::get_document_template_version::{Request, Response};

#[allow(unused_imports)]
use rerp_documents_render_gen::handlers::types::TemplateStatus;

#[handler(GetDocumentTemplateVersionController)]
