// Implementation stub for handler 'create_document_rendition'
...
use rerp_documents_render_gen::handlers::create_document_rendition::{Request, Response};
...
#[allow(unused_imports)]
use rerp_documents_render_gen::handlers::types::TemplateSelector;

#[handler(CreateDocumentRenditionController)]
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    // TODO: Implement your business logic here
    //
    // Example: Access request data
    // let document_kind = req.inner.document_kind;// let idempotency_key = req.inner.idempotency_key;// let issued_at = req.inner.issued_at;// let locale = req.inner.locale;// let render_model = req.inner.render_model;// let render_schema = req.inner.render_schema;// let source = req.inner.source;// let template_selector = req.inner.template_selector;
    //
