// Implementation stub for handler 'list_document_templates'
...
use rerp_documents_render_gen::handlers::list_document_templates::{Request, Response};

#[allow(unused_imports)]
use rerp_documents_render_gen::handlers::types::DocumentTemplate;
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let page = req.inner.page;// let limit = req.inner.limit;// let document_kind = req.inner.document_kind;// let status = req.inner.status;
    //
