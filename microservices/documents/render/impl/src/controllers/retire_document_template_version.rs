// Implementation stub for handler 'retire_document_template_version'
...
use rerp_documents_render_gen::handlers::retire_document_template_version::{Request, Response};
