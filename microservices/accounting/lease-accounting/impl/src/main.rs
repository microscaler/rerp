...
use clap::Parser;
use rerp_accounting_lease_accounting_gen::handlers::*;
use rerp_accounting_lease_accounting_gen::registry;
use rerp_accounting_lease_accounting_gen::*;
mod controllers;
use controllers::*;
use std::io;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 lease_accounting example server listening on {addr}");
