...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/documents-extraction/accounting-documents/{id}/classify";
    ...
    let service_name_upper = "documents-extraction".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "documents-extraction", domain_suffix);
