// User-owned controller for handler 'list_depreciation_entries'.
...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/asset/assets/{id}/depreciation";
    ...
    let service_name_upper = "asset".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "asset", domain_suffix);
