// User-owned controller for handler 'list_report_executions'.
...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/financial-reports/report-executions";
    ...
    let service_name_upper = "financial-reports".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "financial-reports", domain_suffix);
