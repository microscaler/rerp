// User-owned controller for handler 'create_invoice_credit_note'.
...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/invoice/invoices/{id}/credit-note";
    ...
    let service_name_upper = "invoice".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "invoice", domain_suffix);
