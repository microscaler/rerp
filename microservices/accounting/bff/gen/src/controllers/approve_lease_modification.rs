...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/lease-accounting/lease-modifications/{id}/approve";
    ...
    let service_name_upper = "lease-accounting".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "lease-accounting", domain_suffix);
