...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/consolidation/consolidation-runs/{id}/execute";
    ...
    let service_name_upper = "consolidation".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "consolidation", domain_suffix);
