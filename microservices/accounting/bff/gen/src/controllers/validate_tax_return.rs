...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/tax-compliance/tax-returns/{id}/validate";
    ...
    let service_name_upper = "tax-compliance".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "tax-compliance", domain_suffix);
