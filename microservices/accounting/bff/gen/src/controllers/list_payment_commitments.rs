// User-owned controller for handler 'list_payment_commitments'.
...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/accounts-payable/commitments";
    ...
    let service_name_upper = "accounts-payable".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "accounts-payable", domain_suffix);
