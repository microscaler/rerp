...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    Response {
        ...
        discount_amount: Some(rust_decimal::Decimal::new(0, 1)),
        ...
        outstanding_amount: Some(rust_decimal::Decimal::new(110000, 1)),
        paid_amount: Some(rust_decimal::Decimal::new(0, 1)),
        ...
        subtotal: Some(rust_decimal::Decimal::new(100000, 1)),
        tax_amount: Some(rust_decimal::Decimal::new(10000, 1)),
        total_amount: Some(rust_decimal::Decimal::new(110000, 1)),
