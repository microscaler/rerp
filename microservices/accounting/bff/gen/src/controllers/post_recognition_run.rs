...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/revenue-recognition/recognition-runs/{id}/post";
    ...
    let service_name_upper = "revenue-recognition".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "revenue-recognition", domain_suffix);
