// User-owned controller for handler 'update_tax_repartition_line'.
...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/general-ledger/tax-repartition-lines/{id}";
    ...
    let service_name_upper = "general-ledger".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "general-ledger", domain_suffix);
