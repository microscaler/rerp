// User-owned controller for handler 'sign_signature_request'.
...
pub fn handle(req: HandlerRequest) -> HandlerResponse {
    ...
    let path_str = "/api/audit-controls/signature-requests/{id}/sign";
    ...
    let service_name_upper = "audit-controls".to_uppercase();
    ...
    let service_fqdn = format!("{}.{}", "audit-controls", domain_suffix);
