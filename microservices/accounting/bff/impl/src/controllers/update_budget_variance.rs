// Implementation stub for handler 'update_budget_variance'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path update_budget_variance --force
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let actual_amount = req.inner.actual_amount;// let budget_amount = req.inner.budget_amount;// let exceeds_threshold = req.inner.exceeds_threshold;// let is_favorable = req.inner.is_favorable;// let variance = req.inner.variance;// let id = req.inner.id;
    //
