...
use rerp_accounting_bff_gen::handlers::create_ar_aging::{Request, Response};
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let aging_date = req.inner.aging_date;// let company_id = req.inner.company_id;// let currency_code = req.inner.currency_code;// let customer_id = req.inner.customer_id;
    //
