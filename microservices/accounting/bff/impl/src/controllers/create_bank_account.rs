...
use rerp_accounting_bff_gen::handlers::create_bank_account::{Request, Response};
...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    Response {
        ...
        current_balance: Some(rust_decimal::Decimal::new(314, 2)),
        ...
        reconciled_balance: Some(rust_decimal::Decimal::new(314, 2)),
