...
use rerp_accounting_bff_gen::handlers::create_invoice_line::{Request, Response};
...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    //   "line_total": rust_decimal::Decimal::new(10000, 0),
    ...
    Response {
        ...
        line_total: Some(rust_decimal::Decimal::new(10000, 0)),
