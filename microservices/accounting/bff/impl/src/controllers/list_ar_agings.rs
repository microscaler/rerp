// Implementation stub for handler 'list_ar_agings'
...
use rerp_accounting_bff_gen::handlers::list_ar_agings::{Request, Response};

#[allow(unused_imports)]
use rerp_accounting_bff_gen::handlers::types::ArAging;
