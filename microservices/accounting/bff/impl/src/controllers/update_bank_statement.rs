// Implementation stub for handler 'update_bank_statement'
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let reconciled_at = req.inner.reconciled_at;// let reconciled_by = req.inner.reconciled_by;// let status = req.inner.status;// let id = req.inner.id;
    //
