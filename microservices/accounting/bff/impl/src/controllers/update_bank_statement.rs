...
use rerp_accounting_bff_gen::handlers::update_bank_statement::{Request, Response};
...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    //   "closing_balance": rust_decimal::Decimal::new(51000, 0),
    ...
    Response {
        ...
        closing_balance: Some(rust_decimal::Decimal::new(51000, 0)),
        ...
        opening_balance: Some(rust_decimal::Decimal::new(45000, 0)),
        ...
        total_credits: Some(rust_decimal::Decimal::new(314, 2)),
        total_debits: Some(rust_decimal::Decimal::new(314, 2)),
