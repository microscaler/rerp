...
use rerp_accounting_bff_gen::handlers::create_budget_variance::{Request, Response};
...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    //   "actual_amount": rust_decimal::Decimal::new(95000, 0),
    ...
    Response {
        ...
        actual_amount: Some(rust_decimal::Decimal::new(95000, 0)),
        ...
        variance_percent: Some(rust_decimal::Decimal::new(-5, 0)),
    }
}
