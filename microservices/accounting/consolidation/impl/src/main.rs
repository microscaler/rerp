...
use clap::Parser;
use rerp_accounting_consolidation_gen::handlers::*;
use rerp_accounting_consolidation_gen::registry;
use rerp_accounting_consolidation_gen::*;
mod controllers;
use controllers::*;
use std::io;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 consolidation example server listening on {addr}");
