// Implementation stub for handler 'update_line_item'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path update_line_item --force

use brrtrouter::typed::TypedHandlerRequest;
use brrtrouter_macros::handler;
use rerp_accounting_invoice_gen::handlers::update_line_item::{Request, Response};

#[handler(UpdateLineItemController)]
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    // TODO: Implement your business logic here
    //
    // Example: Access request data
    // let description = req.inner.description;// let discount_amount = req.inner.discount_amount;// let discount_percent = req.inner.discount_percent;// let gl_account_credit = req.inner.gl_account_credit;// let gl_account_debit = req.inner.gl_account_debit;// let quantity = req.inner.quantity;// let tax_code = req.inner.tax_code;// let unit_price = req.inner.unit_price;// let id = req.inner.id;// let line_id = req.inner.line_id;
    //
