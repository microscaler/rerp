...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    //   "status": "DRAFT",
    //   "subtotal": rust_decimal::Decimal::new(0, 0),
    //   "tax_amount": rust_decimal::Decimal::new(0, 0),
    //   "total_amount": rust_decimal::Decimal::new(0, 0),
    ...
    Response {
        ...
        outstanding_amount: Some(rust_decimal::Decimal::new(0, 0)),
        ...
        subtotal: Some(rust_decimal::Decimal::new(0, 0)),
        tax_amount: Some(rust_decimal::Decimal::new(0, 0)),
        total_amount: Some(rust_decimal::Decimal::new(0, 0)),
