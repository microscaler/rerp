...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let auto_confirm = req.inner.auto_confirm;// let billing_address_id = req.inner.billing_address_id;// let company_id = req.inner.company_id;// let currency_code = req.inner.currency_code;// let due_date = req.inner.due_date;// let entity_id = req.inner.entity_id;// let exchange_rate = req.inner.exchange_rate;// let internal_notes = req.inner.internal_notes;// let invoice_type = req.inner.invoice_type;// let issued_date = req.inner.issued_date;// let line_items = req.inner.line_items;// let notes = req.inner.notes;// let shipping_address_id = req.inner.shipping_address_id;
    //
