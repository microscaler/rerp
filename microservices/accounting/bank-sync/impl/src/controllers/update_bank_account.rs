...
use bank_sync_service_api::handlers::update_bank_account::{Request, Response};
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let account_name = req.inner.account_name;// let account_type = req.inner.account_type;// let bank_code = req.inner.bank_code;// let bank_name = req.inner.bank_name;// let is_active = req.inner.is_active;// let sync_provider = req.inner.sync_provider;// let id = req.inner.id;
    //
