...
use rerp_accounting_bank_sync_gen::handlers::types::CreateBankTransactionRequest;
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let bank_account_id = req.inner.bank_account_id;// let closing_balance = req.inner.closing_balance;// let currency_code = req.inner.currency_code;// let file_reference = req.inner.file_reference;// let opening_balance = req.inner.opening_balance;// let start_date = req.inner.start_date;// let statement_date = req.inner.statement_date;// let statement_number = req.inner.statement_number;// let transactions = req.inner.transactions;
    //
