// This file uses generated code from the rerp_accounting_asset_gen crate
...
use rerp_accounting_asset_gen::handlers::*;
use rerp_accounting_asset_gen::registry::*;
use rerp_accounting_asset_gen::*;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 asset_management example server listening on {addr}");
