...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let custodian_id = req.inner.custodian_id;// let department_id = req.inner.department_id;// let description = req.inner.description;// let location = req.inner.location;// let name = req.inner.name;// let notes = req.inner.notes;// let status = req.inner.status;// let id = req.inner.id;
    //
