...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    //   "outstanding_amount": rust_decimal::Decimal::new(5500, 0),
    //   "status": "PARTIAL",
    ...
    Response {
        ...
        credit_limit: Some(rust_decimal::Decimal::new(314, 2)),
        credit_used: Some(rust_decimal::Decimal::new(314, 2)),
        ...
        last_payment_amount: Some(rust_decimal::Decimal::new(314, 2)),
        last_payment_date: Some("example".to_string()),
        metadata: Some(Default::default()),
        outstanding_amount: Some(rust_decimal::Decimal::new(5500, 0)),
        updated_at: Some("2024-01-15T11:00:00Z".to_string()),
        write_off_amount: Some(rust_decimal::Decimal::new(314, 2)),
