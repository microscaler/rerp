...
use rerp_accounting_accounts_receivable_gen::handlers::update_payment::{Request, Response};
...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    //   "payment_amount": rust_decimal::Decimal::new(5500, 0),
    ...
    Response {
        applied_amount: Some(rust_decimal::Decimal::new(314, 2)),
        ...
        unapplied_amount: Some(rust_decimal::Decimal::new(314, 2)),
