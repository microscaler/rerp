...
impl TryFrom<HandlerRequest> for Request {
    ...
    fn try_from(req: HandlerRequest) -> Result<Self, Self::Error> {
        ...
        if let Some(v) = req.get_query_param("activity_type") {
        
            data_map.insert(
                "activity_type".to_string(),
                brrtrouter::server::request::decode_param_value(
                    v,Some(&serde_json::json!({"enum":["PHONE","EMAIL","LETTER","VISIT","REMINDER","DUNNING","DISPUTE","PAYMENT_PLAN"],"type":"string"})),None,None,
                ),
            );
        } else {
        ...
        if let Some(v) = req.get_query_param("assigned_to") {
        ...
        if let Some(v) = req.get_query_param("due_before") {
            ...
            data_map.insert(
                ...
                brrtrouter::server::request::decode_param_value(
                    v,Some(&serde_json::json!({"format":"date","type":"string"})),None,None,
                ),
            );
        } else {
...
pub fn handler(req: TypedHandlerRequest<Request>) -> Response {
    crate::controllers::list_collection_activities::handle(req)
}
