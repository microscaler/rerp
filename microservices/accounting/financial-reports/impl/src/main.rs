// This file uses generated code from the financial_reports_service_api crate
...
use financial_reports_service_api::handlers::*;
use financial_reports_service_api::registry::*;
use financial_reports_service_api::*;
