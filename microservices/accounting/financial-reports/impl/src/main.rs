// This file uses generated code from the rerp_accounting_financial_reports_gen crate
...
use rerp_accounting_financial_reports_gen::handlers::*;
use rerp_accounting_financial_reports_gen::registry::*;
use rerp_accounting_financial_reports_gen::*;
...
#[derive(Parser)]
struct Args {
    #[arg(short, long, default_value = "../gen/doc/openapi.yaml")]
    spec: PathBuf,
    #[arg(long)]
    static_dir: Option<PathBuf>,
    #[arg(long, default_value = "../gen/doc")]
    doc_dir: PathBuf,
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 financial_reports example server listening on {addr}");
