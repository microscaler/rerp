...
use clap::Parser;
use rerp_accounting_audit_controls_gen::handlers::*;
use rerp_accounting_audit_controls_gen::registry;
use rerp_accounting_audit_controls_gen::*;
mod controllers;
use controllers::*;
use std::io;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 audit_controls example server listening on {addr}");
