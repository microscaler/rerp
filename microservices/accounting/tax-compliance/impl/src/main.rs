...
use clap::Parser;
use rerp_accounting_tax_compliance_gen::handlers::*;
use rerp_accounting_tax_compliance_gen::registry;
use rerp_accounting_tax_compliance_gen::*;
mod controllers;
use controllers::*;
use std::io;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 tax_compliance example server listening on {addr}");
