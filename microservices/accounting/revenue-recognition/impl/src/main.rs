...
use clap::Parser;
use rerp_accounting_revenue_recognition_gen::handlers::*;
use rerp_accounting_revenue_recognition_gen::registry;
use rerp_accounting_revenue_recognition_gen::*;
mod controllers;
use controllers::*;
use std::io;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 revenue_recognition example server listening on {addr}");
