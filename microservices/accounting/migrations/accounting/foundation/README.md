...
psql -v ON_ERROR_STOP=1 -h 127.0.0.1 -U postgres -d rerp_phase1_test \
  -f microservices/accounting/migrations/accounting/foundation/0001_generated_entities.sql
psql -v ON_ERROR_STOP=1 -h 127.0.0.1 -U postgres -d rerp_phase1_test \
  -f microservices/accounting/migrations/accounting/foundation/0002_controls_and_rls.sql
psql -v ON_ERROR_STOP=1 -h 127.0.0.1 -U postgres -d rerp_phase1_test \
  -f microservices/accounting/migrations/accounting/foundation/0003_document_artifacts.sql
psql -v ON_ERROR_STOP=1 -h 127.0.0.1 -U postgres -d rerp_phase1_test \
