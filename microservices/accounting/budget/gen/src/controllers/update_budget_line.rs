...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    Response {
        ...
        actual_amount: Some(rust_decimal::Decimal::new(12345, 2)),
        budget_amount: Some(rust_decimal::Decimal::new(1100000, 1)),
        ...
        variance_percent: Some(rust_decimal::Decimal::new(12345, 2)),
