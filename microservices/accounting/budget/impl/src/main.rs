// This file uses generated code from the rerp_accounting_budget_gen crate
...
use rerp_accounting_budget_gen::handlers::*;
use rerp_accounting_budget_gen::registry::*;
use rerp_accounting_budget_gen::*;
