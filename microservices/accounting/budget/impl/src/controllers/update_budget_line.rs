...
use rerp_accounting_budget_gen::handlers::update_budget_line::{Request, Response};
...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    //   "budget_amount": rust_decimal::Decimal::new(110000, 0),
    ...
    Response {
        ...
        budget_amount: Some(rust_decimal::Decimal::new(110000, 0)),
