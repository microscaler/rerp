// This file uses generated code from the rerp_accounting_edi_gen crate
...
use rerp_accounting_edi_gen::handlers::*;
use rerp_accounting_edi_gen::registry::*;
use rerp_accounting_edi_gen::*;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 edi___compliance example server listening on {addr}");
