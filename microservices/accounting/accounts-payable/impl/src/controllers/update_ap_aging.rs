// Implementation stub for handler 'update_ap_aging'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path update_ap_aging --force

use accounts_payable_service_api::handlers::update_ap_aging::{Request, Response};
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let current = req.inner.current;// let days_31_60 = req.inner.days_31_60;// let days_61_90 = req.inner.days_61_90;// let days_91_120 = req.inner.days_91_120;// let over_120 = req.inner.over_120;// let total_outstanding = req.inner.total_outstanding;// let id = req.inner.id;
    //
