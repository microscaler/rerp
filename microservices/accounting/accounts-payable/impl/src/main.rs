// This file uses generated code from the rerp_accounting_accounts_payable_gen crate
...
use rerp_accounting_accounts_payable_gen::handlers::*;
use rerp_accounting_accounts_payable_gen::registry::*;
use rerp_accounting_accounts_payable_gen::*;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 accounts_payable example server listening on {addr}");
