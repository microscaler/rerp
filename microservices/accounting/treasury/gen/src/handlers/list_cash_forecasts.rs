...
pub struct Request {
    ...
    pub horizon: Option<serde_json::Value>,
}
...
impl TryFrom<HandlerRequest> for Request {
    ...
    fn try_from(req: HandlerRequest) -> Result<Self, Self::Error> {
        ...
        if let Some(v) = req.get_query_param("horizon") {
            data_map.insert(
                "horizon".to_string(),
                brrtrouter::server::request::decode_param_value(
                    v,Some(&serde_json::json!({"enum":["DAILY_13_WEEK","MONTHLY_12_MONTH","QUARTERLY_8_QUARTER","CUSTOM"]})),None,None,
                ),
            );
        } else {
...
pub fn handler(req: TypedHandlerRequest<Request>) -> Response {
    crate::controllers::list_cash_forecasts::handle(req)
}
