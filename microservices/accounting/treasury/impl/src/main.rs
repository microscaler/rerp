...
use clap::Parser;
use rerp_accounting_treasury_gen::handlers::*;
use rerp_accounting_treasury_gen::registry;
use rerp_accounting_treasury_gen::*;
mod controllers;
use controllers::*;
use std::io;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 treasury example server listening on {addr}");
