// Implementation stub for handler 'close_fiscal_year'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path close_fiscal_year --force

use brrtrouter::typed::TypedHandlerRequest;
use brrtrouter_macros::handler;
use rerp_accounting_general_ledger_gen::handlers::close_fiscal_year::{Request, Response};

#[handler(CloseFiscalYearController)]
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    // TODO: Implement your business logic here
    //
    // Example: Access request data
    // let closing_date = req.inner.closing_date;// let id = req.inner.id;
    //
