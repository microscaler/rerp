// Implementation stub for handler 'update_payment_term'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path update_payment_term --force

use brrtrouter::typed::TypedHandlerRequest;
use brrtrouter_macros::handler;
use rerp_accounting_general_ledger_gen::handlers::update_payment_term::{Request, Response};
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let description = req.inner.description;// let installment_lines = req.inner.installment_lines;// let is_active = req.inner.is_active;// let name = req.inner.name;// let id = req.inner.id;
    //
