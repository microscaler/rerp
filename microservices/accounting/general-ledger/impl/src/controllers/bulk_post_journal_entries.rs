// Implementation stub for handler 'bulk_post_journal_entries'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path bulk_post_journal_entries --force

use brrtrouter::typed::TypedHandlerRequest;
use brrtrouter_macros::handler;
use general_ledger_service_api::handlers::bulk_post_journal_entries::{Request, Response};
