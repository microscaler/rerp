// Implementation stub for handler 'update_tax_repartition_line'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path update_tax_repartition_line --force

use brrtrouter::typed::TypedHandlerRequest;
use brrtrouter_macros::handler;
use rerp_accounting_general_ledger_gen::handlers::update_tax_repartition_line::{
    Request, Response,
};

#[handler(UpdateTaxRepartitionLineController)]
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    // TODO: Implement your business logic here
    //
    // Example: Access request data
    // let account_id = req.inner.account_id;// let ratio = req.inner.ratio;// let tag_ids = req.inner.tag_ids;// let id = req.inner.id;
    //
