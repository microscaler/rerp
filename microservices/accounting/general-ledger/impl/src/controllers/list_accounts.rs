...
use rerp_accounting_general_ledger_gen::handlers::list_accounts::{Request, Response};
use brrtrouter::typed::TypedHandlerRequest;


#[allow(unused_imports)]
use rerp_accounting_general_ledger_gen::handlers::types::Account;
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let page = req.inner.page;// let limit = req.inner.limit;// let search = req.inner.search;// let account_type = req.inner.account_type;// let parent_id = req.inner.parent_id;// let active = req.inner.active;
    //
