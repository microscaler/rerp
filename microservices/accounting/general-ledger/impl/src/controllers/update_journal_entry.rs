...
use general_ledger_service_api::handlers::update_journal_entry::{Request, Response};

#[allow(unused_imports)]
use general_ledger_service_api::handlers::types::LineItemRequest;
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let description = req.inner.description;// let entry_date = req.inner.entry_date;// let lines = req.inner.lines;// let reference_number = req.inner.reference_number;// let id = req.inner.id;
    //
