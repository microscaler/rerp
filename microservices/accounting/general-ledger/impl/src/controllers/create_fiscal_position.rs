// Implementation stub for handler 'create_fiscal_position'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path create_fiscal_position --force

use brrtrouter::typed::TypedHandlerRequest;
use brrtrouter_macros::handler;
use rerp_accounting_general_ledger_gen::handlers::create_fiscal_position::{Request, Response};
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let account_mappings = req.inner.account_mappings;// let auto_apply = req.inner.auto_apply;// let code = req.inner.code;// let company_id = req.inner.company_id;// let country_id = req.inner.country_id;// let description = req.inner.description;// let name = req.inner.name;// let state_ids = req.inner.state_ids;// let tax_mappings = req.inner.tax_mappings;
    //
