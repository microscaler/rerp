// Implementation stub for handler 'update_fiscal_period'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path update_fiscal_period --force

use brrtrouter::typed::TypedHandlerRequest;
use brrtrouter_macros::handler;
use rerp_accounting_general_ledger::handlers::update_fiscal_period::{Request, Response};
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let end_date = req.inner.end_date;// let is_locked = req.inner.is_locked;// let is_open = req.inner.is_open;// let name = req.inner.name;// let start_date = req.inner.start_date;// let id = req.inner.id;
    //
