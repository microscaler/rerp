// This file uses generated code from the rerp_accounting_general_ledger crate
...
use rerp_accounting_general_ledger::handlers::*;
use rerp_accounting_general_ledger::registry;
use rerp_accounting_general_ledger::*;
...
fn main() -> io::Result<()> {
    ...
    println!("🚀 general_ledger example server listening on {addr}");
