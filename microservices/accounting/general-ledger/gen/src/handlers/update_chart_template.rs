...
pub struct Response {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "fiscal_day")]
    pub fiscal_day: Option<i32>,

    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "fiscal_month")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "include_subperiods")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "number_of_periods")]
...
pub fn handler(req: TypedHandlerRequest<Request>) -> HttpJson<Response> {
    crate::controllers::update_chart_template::handle(req)
}
