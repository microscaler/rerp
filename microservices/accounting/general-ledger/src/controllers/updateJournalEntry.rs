// User-owned controller for handler 'updateJournalEntry'.
use crate::handlers::updateJournalEntry::{Request, Response};
...
pub fn handle(_req: TypedHandlerRequest<Request>) -> Response {
    ...
    Response {
        ...
        description: "Monthly accrual entry (Updated)".to_string(),
