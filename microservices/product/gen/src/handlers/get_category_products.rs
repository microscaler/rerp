...
impl TryFrom<HandlerRequest> for Request {
    ...
    fn try_from(req: HandlerRequest) -> Result<Self, Self::Error> {
        ...
        if let Some(v) = req.get_path_param("categoryId") {
            ...
            return Err(anyhow::anyhow!("Missing required parameter 'categoryId'"));
...
pub fn handler(req: TypedHandlerRequest<Request>) -> Response {
    crate::controllers::get_category_products::handle(req)
}
