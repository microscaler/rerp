...
impl TryFrom<HandlerRequest> for Request {
    ...
    fn try_from(req: HandlerRequest) -> Result<Self, Self::Error> {
        ...
        if let Some(v) = req.get_path_param("roleId") {
            ...
            return Err(anyhow::anyhow!("Missing required parameter 'roleId'"));
            
        }
        
        
        if let Some(v) = req.get_path_param("permissionId") {
            ...
            return Err(anyhow::anyhow!("Missing required parameter 'permissionId'"));
...
pub fn handler(req: TypedHandlerRequest<Request>) -> Response {
    crate::controllers::revoke_permission::handle(req)
}
