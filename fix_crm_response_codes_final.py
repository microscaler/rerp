"""
Fix all remaining response codes across 11 CRM specs.

Based on the audit:
- 201: 135 missing from POST ops (that create, not action triggers)
- 204: 154 missing from PUT/PATCH ops (that update, not actions)
- 400: 111 missing from write ops
- 409: 136 missing from conflict-prone ops

This adds the missing codes to ALL operations.
"""
import yaml
import os
...
# Action triggers that return 200 (execute, don't create/update)
TRUE_ACTIONS = {
