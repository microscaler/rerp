...
- **Build and Test**: Patches deps for CI, builds workspace (amd64), example service (accounting/accounts-payable), and accounting microservices (smoke test), format/lint/test/doc.
